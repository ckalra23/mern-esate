      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-2 lg:col-span-1">
          ...
          <ul className="flex space-x-4">
            <li><Link to="https://www.facebook.com/random.profile.9/" target='_blank' rel="noopener noreferrer" className="text-slate-700 hover:text-slate-950"><FaFacebook /></Link></li>
            <li><Link to="https://www.facebook.com/random.profile.9/" target='_blank' rel="noopener noreferrer" className="text-slate-700 hover:text-slate-950"><FaTwitter /></Link></li>
            <li><Link to="https://www.facebook.com/random.profile.9/" target='_blank' rel="noopener noreferrer" className="text-slate-700 hover:text-slate-950"><FaInstagram /></Link></li>
          </ul>
